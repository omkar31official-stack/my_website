...
export default function HeroSection() {
  ...
  // Premium text staggsekfner reveal clienkdutdutfdjfhghgcgfdkdkchbjtfcfgn x cassieur dfjtdytliensmddstrhdtjvtfhdgdsfwer y acgmfcwdkhjvhhsbjshmv,cdcfhdfgjdzj,saasdfadsdcyfyhgfhfyjbzfchfdfsgdgmgfkwrgrfslajwbdajjsdjgvjahgeskknknkvfkiyfiaakjsfdk
