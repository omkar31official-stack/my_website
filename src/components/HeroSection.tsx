...
export default function HeroSection() {
  ...
  // Premium text staggsekfner reveal clienkdutdutfdjfhghgcgfdkdkchu6d75bjtfcfgn x cassieur dfjtdytliensmddstrhdtjvtfhdgdsfwer y acgmfcwdkhjvhhsbjshmv,cdcfhdfgjdzj,saasdfadsdcyfyhgfhfyjbzfchfdfsgdgmgfkwrgrfslajwbdajjsdjgvjahgeskknknkvfkiyfiaakjsfdk
