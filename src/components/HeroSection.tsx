...
export default function HeroSection() {
  ...
  // Premium text stagger reveal client x client y and th emore  keep my sLWDJLWBdjbtreakljgutdutd oka maintianned wroceprnvn okmakr is the main thing herwe 
