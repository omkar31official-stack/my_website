...
export default function HeroSection() {
  ...
  // Premium text staggsekfner reveal clienkduutruttdutfdjfhghgcgfdkdkchu6d75bjtfcfgn x cassieur dfjtdytliensmddstrhdtjvtfhdgdsfwer y acgmfcwdkhjvhhsbjshmv,cdcfhdfgjdzj,saasdfadsdcyfyhgfhfyjbzfchfdfsgdgmgfkwrgrfslajwbdajjsdjgvjahgeskknknkvfkiyfiaakjsfdk
