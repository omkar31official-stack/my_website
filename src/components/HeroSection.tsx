...
export default function HeroSection() {
  ...
  // Premium text staggsekfner reveal clienkdjfhghgcgfdkdkchbjt x casdfjtdytliensmdvtfhdgdsfwer y acgmfcwdkhjvhhsbjshmv,cdcfhdfgjdzj,saasdfadsdcyfyhgfhfyjbzfchfdfsgdgmgfkwrgrfslajwbdajjsdjgvjahgeskknknkvfkiyfiaakjsfdk
