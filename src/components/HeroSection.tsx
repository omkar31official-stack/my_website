...
export default function HeroSection() {
  ...
  // Premium text staggsekfner khg clienkduutruttdutfdjfhghgcgfdkdkchu6d75bjtfcjyftfgn x cjgkhfjgcassieur dfjtdytliensmddstrhdtjvtfhdgdsfwer y acgmfcwdkhjvhhsbjshmv,cdcfhdfgjdzj,saasdfadsdcyfyhgfhfyjbzfchfdfsgdgmgfkwrgrfslajwbdajjsdjgvjahgeskknknkvfkiyfiaakjsfdk
