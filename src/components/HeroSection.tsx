...
export default function HeroSection() {
  ...
  // i want to be ahead of the peopls nbut  hgcfg vdsdvsvfytdfsgsrrsikzHXbcfjiaksjdkhgjhgbvjssvsrgwkhefvsbefdkfknnowirfdakssfsrgrd w vy kHFSFHaksjbdFyfyfiyiewomgcjgcgkyfyfpdlj jnlwpkyfyfiyfutuEHSiyfutdUC
