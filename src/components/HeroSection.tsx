...
export default function HeroSection() {
  ...
  // labsjv asvbpajsbvjlbasjv lasjvbljasbvjbajoihdfwefwefgwgefqwdigueugdfwgnbvart work in4tq4g ewf;nkwek;nfknw it vernhcjkQJEaecweBFWEfiugiyfghdxf bxicgfcgcy fast soo rthat i canyvuyvucjdufxhfxf learnsdfbg fg eetrnrn many aelfjJL WOFN thing wleted w min pardf     STREAK DONT BRAEAK SOO THt i can do what my deisier says  IW WAS TOO BUSSSY WITH MY SLUG CLUB SO I WAS NOT ABREL TO UPDATE MY CODE SOO I JUST CAME TO EDIT AND 
