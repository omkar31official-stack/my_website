...
export default function HeroSection() {
  ...
  // Premium text staggsekfner reveal clienkdjfhghgcgfdkdkchbjtfcfgn x cassieur dfjtdytliensmdvtfhdgdsfwer y acgmfcwdkhjvhhsbjshmv,cdcfhdfgjdzj,saasdfadsdcyfyhgfhfyjbzfchfdfsgdgmgfkwrgrfslajwbdajjsdjgvjahgeskknknkvfkiyfiaakjsfdk
