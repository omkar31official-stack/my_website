...
export default function HeroSection() {
  ...
  // i want to be ahead of the peopls nbut  djzryktxyukty i wqZDkhvgkhvkhhiyfgiyfyfuyututdtyoujgojbouboududuxduxrrtyfiydtBFDZGNGiAS  oigougoohkiyfcgfdutgdttuidurtsyrgouifhhbshcxvahscvvhvihdjbosabdjbgvih  skjcbajsc srhaethryjsbdcBADVHW DkWHDBHQBWfvSHVHvhWHBNSSGNSYNill stlsjdvbljabdlvjbaljsbvjLKASNfLKSAV lSKB vLSJBfjlv 
  // labsjv asvbpajsbvjlbasjv lasjvbljasbvjbajoihdfwefwefgwgefqwdigueugdfwgnbvart working ihvihvihvihviyon it vernhcjkQJEBFWEfiugiyfghdxfbxicgfcgcy fast soo rthat i canyvuyvucjdufxhfxf learnsdfbg fg eetrnrn many aelfjJL WOFN thing wleted w min pardf     STREAK DONT BRAEAK SOO THt i can do what my deisier says  IW WAS TOO BUSSSY WITH MY SLUG CLUB SO I WAS NOT ABREL TO UPDATE MY CODE SOO I JUST CAME TO EDIT AND 
