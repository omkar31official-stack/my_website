...
export default function HeroSection() {
  ...
  // Premium text staggsekfner khouedfgg clwiehvfienkduutruttdutftyjryjdjfhghgcgfdkdkchu6d75bjtfcjyftfgn xsfr cjgkhfjgcassieur dfjtdytliensmddstrhlougidtjvtfhdgdsfwer y acgmfcwdkhjvhhsbjshmv,cdcfhdfgjdzj,saasdfadsdcyfyhgfhfyjbzfchfdfsgdgmgfkwrgrfslajwbdajjsdjgvjahgeskknknkvfkiyfiaakjsfdk
