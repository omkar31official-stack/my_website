...
export default function HeroSection() {
  ...
  // Premium text staggsekfner reveal clienkdjfhghgcgfdkdkchbjtfcfgn x cassieur dfjtdytliensmddstrhdtjvtfhdgdsfwer y acgmfcwdkhjvhhsbjshmv,cdcfhdfgjdzj,saasdfadsdcyfyhgfhfyjbzfchfdfsgdgmgfkwrgrfslajwbdajjsdjgvjahgeskknknkvfkiyfiaakjsfdk
