...
export default function HeroSection() {
  ...
  // i want to be ahead of the peopls nbut  djzryktxyukty i wqZDBFDZGNGiAS srhaethryjsbdcBADVHW DkWHDBHQBWfvSHVHvhWHBNSSGNSYNill stlsjdvbljabdlvjbaljsbvjLKASNfLKSAV lSKB vLSJBfjlv 
