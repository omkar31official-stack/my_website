...
export default function HeroSection() {
  ...
  // i want to be ahead of the peopls nbut  hgcfg vdsdvsvfytdfsgsrrsikzHXbhdvbcfjiaksjdkhgjhgbvjssvsrgwkhefvsbefdkfknnowirfdakssfsrgrd w vy kHFSFHaksjbdFyfyfiyiewomgcjgcgkyfyfpdlj jnlwpkyfyfiyfutuEHSiyfutdUC
