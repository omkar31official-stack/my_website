...
export default function HeroSection() {
  ...
  // Premium text stagger reveal client x client y and th emore w do is the more  threre wscvdvil sucessfuly completed with the slug event thwojb42fojb4gj kejfbwbr min part of the alsdkfnslug hdwcuh wbecib evedfgwhb gusvqgvwgdlwwerterterngfjwnrgjwej kahdbvk wejgrjg sab khcbd yesssss
